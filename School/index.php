        ...
        <div class="card-body">
            <form action="" method="post">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="units" id="units" class="form-control" max="23" placeholder="maximum of 23"required autofocus>
                </div>

                <div class="mb-3 text-center">
                    <div class="form-check form-check-inline">
                        <input type="radio" name="laboratory" id="lab" value="yes"class="form-check-input">
                        <label for="" class="form-check-label">With a lab</label>
                    </div>
