...
class User extends Database{
  // store() inserts a record into the users table
    ...
    public function store($request){  //$request hold the data from the form
        ...
        if($this->conn->query($sql)){
            ...
            if($photo){
                ...
                if($this->conn->query($sql)){
                    ...
                    die("Error in uplooading the photo: " .$this->conn->error);
                }
            } header("location: ../views/dashboard.php");
            exit;
    ...
    public function delete(){
        ...
        if($this->conn->query($sql)){
            ...
            die("Error in deleteing your accont:" . $this->conn->error);
        }
    }
}
