...
<body class="bg-light">
    ...
    <div class="row h-100 m-0">
        <div class="card w-25 my-auto mx-auto">
            <div class="card-header bg-white boder-0 py-3">
            ...
            <div class="card-body">
                <form action="../actions/register.php" method="post">
                    ...
                    <div class="mb-5">
                        <label for="password" class="formm-label fw-bold">Password</label>
                        <input type="password" name="password" id="password" class="form-control" minlegth="8" aria-describedby="passwprd-info" required>
